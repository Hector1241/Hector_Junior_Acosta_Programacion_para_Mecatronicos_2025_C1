...
int main(void)
{
    ...
    /* La función strchr busca la posición en la que se encuentra un determinado
       caracter en la cadena de caracteres. Si lo encuentra regresa un apuntador
       a la primera ocurrencia del caracter en la cadena, de otra forma regresa NULL. */
    if (c != NULL)
    {
